...
export const CHAT_THEMES: Record<ChatTheme, { label: string; gradient: string }> = {
  default: { label: "Mặc định", gradient: "bg-white" },
  sky: { label: "Sky", gradient: "bg-gradient-to-b from-[#E8F5E9] to-[#C8E6C9]" },
  mint: { label: "Mint", gradient: "bg-gradient-to-br from-[#E9FFF6] to-[#D4F5E8]" },
  sunset: { label: "Sunset", gradient: "bg-gradient-to-br from-[#FFF1E6] to-[#FFDCC6]" },
};
